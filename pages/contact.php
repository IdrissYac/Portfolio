...
<head>
    ...
    <style>
        body { font-family: 'Roboto', sans-serif; font-size: 14px; color: #333; }
        .email-container { max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f4f4f9; border-radius: 8px; }
        .email-header { background-color: #58b3c4; color: #fff; padding: 10px; text-align: center; border-radius: 8px; }
